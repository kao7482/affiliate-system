...
class Database_Query
{
    ...
    protected $_multi_query_result_count = null;
	/**
	...
	*/
	public function __construct($sql, $type = null, $multi_query_result_count = null)
	{
		$this->_type = $type;
		$this->_sql = $sql;
        $this->_multi_query_result_count = $multi_query_result_count;
	}
	...
	public function execute($db = null)
	{
		...
		// Execute the query
		\DB::$query_count++;
		$result = $db->query($this->_type, $sql, $this->_as_object, $this->_multi_query_result_count);
